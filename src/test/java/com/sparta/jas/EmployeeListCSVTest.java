...
public class EmployeeListCSVTest {
    ...
    public static void setupClass(){
        ...
        employeeList = dataReader.streamList();
    }

    @Test
    public void outputEmployeeTest(){
        String expectedOutput = "Emp ID=260736, Name Prefix=Ms., First Name=Zelda, Middle Initial=P, Last Name=Forest, Gender=F, E Mail=zelda.forest@ibm.com, Date of Birth=1959-11-27, Date of Joining=2014-01-28, Salary=176642";
